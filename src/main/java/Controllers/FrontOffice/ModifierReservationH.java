...
public class ModifierReservationH {
    ...
    private ReservationH oldReservationH;
    ...
    void modify_and_return(ActionEvent event) {
        try {
            if (id_nb_adultes.getText() != null && id_nb_enfants.getText() != null && id_repartition.getText() != null && id_arrangement.getText() != null && id_dateArrivee.getText() != null && id_dateDepart.getText() != null ) {
                ...
                ReservationH modifiedReservation = new ReservationH(
                        oldReservationH.getId(),
                ...
                srh.modifier(modifiedReservation);

                // Show success message
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Success");
                alert.setContentText("Reservation d'Hôtel modifiée avec succès");
                alert.showAndWait();
