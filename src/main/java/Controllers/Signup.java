...
public class Signup {
            ...
            public void handle(DragEvent event) {
                ...
                if (db.hasFiles()) {
                    ...
                    for (File file : db.getFiles()) {
                        ...
                        File destinationFile = new File("C:\\final\\public\\uploads\\files\\" + file.getName());
                        try {
    ...
    void signup(ActionEvent event) throws IOException {
        ...
        if (userService.test_Email(email_tf.getText()) && userService.test_Tel(numtel_tf.getText()) && userService.test_dateNaissance(date_pick.getValue()))
        {
            ...
            if (!nom_tf.getText().isEmpty() && !prenom_tf.getText().isEmpty() && !email_tf.getText().isEmpty() && !password_tf.getText().isEmpty() && !numtel_tf.getText().isEmpty() && !selectedRoles.isEmpty())
            {
                User user = new User(nom_tf.getText(), password_tf.getText(), email_tf.getText(), password_tf.getText(), dateNaissance, numtel_tf.getText(), selectedRoles, null, url_image, "ACTIF");
                ...
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Check infos");
                alert.setContentText("Check infos !");
                alert.show();
            }
        }
        else
    ...
    void add_image(MouseEvent event) {
        ...
        if (selectedFile != null) {
            ...
            File destinationFile = new File("C:\\final\\public\\uploads\\files\\" + selectedFile.getName());
