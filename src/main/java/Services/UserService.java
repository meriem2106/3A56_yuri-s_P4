...
public class UserService implements UserInterface{
    ...
    public void ajouterUser(User user) throws SQLException {
        ...
        String query = "INSERT INTO utilisateur (nom, roles, password, prenom, num_de_telephone, email, datedenaissance, file) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void modifierUser(User user, int id) {
        ...
        try {
            ...
            String query = "UPDATE utilisateur SET nom=?, prenom=?, num_de_telephone=?, email=?, password=?, datedenaissance=?, file=?, roles=? WHERE id=?";
            PreparedStatement preparedStatement = conn.prepareStatement(query);
